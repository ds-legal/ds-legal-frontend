...
function Login() {
    ...
    return (
        <>
        <div className="md:w-[80%] w-full h-[100vh]  mx-auto flex items-center justify-center lg:py-0 py-10 overflow-x-hidden">
        ...
        <p className="text-[18px] text-[#E4DBDB] mt-2">Introducing our light-weight admin
        companion built for legal professionals with features that enhance productivity
        without the complexities of sensitive data storage.</p>
        </div>
        <div className="bg-[#212121] p-6 rounded-md">
        <p className="text-[#F0E6E6] text-[16px]">Lorem ipsum dolor sit amet consectetur.
            Et molestie arcu elit ut. Porttitor ut vulputate amet neque nibh.</p>
